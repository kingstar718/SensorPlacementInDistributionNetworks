...
def generate_timematrix(exepath, inpath, rptpath, sourcequality, duration, qual_reportstep, qualindex, regularmatch, nodeCount):
    ...
    for nodenum in range(nodeCount):
        ...
        timelist = generate_timelist(waterqualitylist, nodenum, nodeCount, duration, qualindex)
...
if __name__ == "__main__":
    ...
    regularmatch1 = '  [0-9]'
    nodeCount1 = 36
    net2_matrix = generate_timematrix(exe1,input1,rpt1,sourcequality1,duration1,qual_reportstep1,qualindex1,regularmatch1,nodeCount1)
    print(net2_matrix)